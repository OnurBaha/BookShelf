...
namespace DataAccess.Migrations
{
    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ReadingPlanBooks",
                columns: table => new
                {
                    BooksId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReadingPlansId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingPlanBooks", x => new { x.BooksId, x.ReadingPlansId });
                    table.ForeignKey(
                        name: "FK_ReadingPlanBooks_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadingPlanBooks_ReadingPlans_ReadingPlansId",
                        column: x => x.ReadingPlansId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingPlanBooks_ReadingPlansId",
                table: "ReadingPlanBooks",
                column: "ReadingPlansId");
